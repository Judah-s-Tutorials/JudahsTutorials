...
public class EquationDemo3
{
    ...
    public static void main(String[] args)
    {
        ...
        {
            EquationDemo3   demo    = new EquationDemo3( bufReader );
            demo.execute();
        }
    ...
    public EquationDemo3( BufferedReader reader )
    {
        this.reader = reader;
        root.start();
    }
    ...
    private Command getCommand() throws IOException
    {
        ...
        cmd = processInput( line );
        return cmd;
    }
        
    private Command processInput( String line )
    {
        Command cmd     = Command.NONE;
        int     len     = line.length();
