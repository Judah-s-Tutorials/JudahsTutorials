 ...
 * @author Jack Straub
 */
public class ProfileEditorTestGUI_old
{
    ...
    /**
     * Instantiates and returns a ProfileEditorTestGUI_old.
     ...
     */
    public static ProfileEditorTestGUI_old getTestGUI( Profile profile )
    {
        if ( testGUI != null )
            ;
        else if ( SwingUtilities.isEventDispatchThread() )
            testGUI = new ProfileEditorTestGUI_old( profile );
        else
     ...
     */
    private ProfileEditorTestGUI_old( Profile profile )
    {
    ...
    private class GraphPropertyComponents
    {
        ...
        public int getBGColor()
        {
            int iColor  = ProfileEditorTestGUI_old.getColor( colorComponent );
            return iColor;
        }
        ...
        public int getFGColor()
        {
            int iColor  = ProfileEditorTestGUI_old
