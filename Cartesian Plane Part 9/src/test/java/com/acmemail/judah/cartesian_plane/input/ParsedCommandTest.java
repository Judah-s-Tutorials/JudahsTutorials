...
public class ParsedCommandTest
{
    ...
    public void testCtorNonNullArgs()
    {
        ...
        assertEquals( command, parsedCommand.command() );
        assertEquals( cmdStr, parsedCommand.commandString() );
        assertEquals( argStr, parsedCommand.argString() );
    }
    ...
    public void testCtorNullArgs()
    {
        ...
        assertNotNull( parsedCommand.commandString() );
        assertTrue( parsedCommand.commandString().isEmpty() );
        assertNotNull( parsedCommand.argString() );
        assertTrue( parsedCommand.argString().isEmpty() );
