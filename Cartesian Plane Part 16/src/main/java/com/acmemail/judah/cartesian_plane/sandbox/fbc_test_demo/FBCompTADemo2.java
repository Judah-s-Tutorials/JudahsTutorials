 ...
 * @author Jack Straub
 */
public class FBCompTADemo2
{
    /** The data file to read. */
    private static final    File    dataFile    = FBCompTA2.getDataFile();
    ...
    /** SpacingFeedBack object to use in this demo. */
    ...
    */
    ...
    {
        SwingUtilities.invokeLater( () -> new FBCompTADemo2() );
    }
     ...
     */
    public FBCompTADemo2()
    {
        String  title   = "FeedbackCompTA Demo 2";
    ...
    {
        Feedback  feedback    =
            new SpacingFeedback( () -> detail.getPropertyValue() );
        Dimension       dim         =
