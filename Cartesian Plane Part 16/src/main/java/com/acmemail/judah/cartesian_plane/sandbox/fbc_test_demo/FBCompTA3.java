...
public class FBCompTA3
{
    ...
    private static final String dataPath    =
        "TestDataDir/Feedback/Stroke";

    // #2
    /** The name of the file used to store test data. */
    private static final String dataFile    = "StrokeData.ser";
    ...
    */
    ...
    public FBCompTA3()
    {
        ...
        // #1
        String  title   = "Stroke Feedback Component Test Assistant";
