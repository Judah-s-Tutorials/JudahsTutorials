...
public class EquationDemo3UserInputWithFileIO
{
    ...
    public static void main( String[] args )
    {
        ...
        {
            EquationDemo3UserInputWithFileIO   demo    = 
                new EquationDemo3UserInputWithFileIO( bufReader );
            demo.execute();
        }
    ...
    public EquationDemo3UserInputWithFileIO( BufferedReader reader )
    {
