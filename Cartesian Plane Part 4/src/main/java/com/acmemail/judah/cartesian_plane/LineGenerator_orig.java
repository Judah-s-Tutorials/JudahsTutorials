 ...
 * @author Jack Straub
 */
public class LineGenerator_orig implements Iterable<Line2D>
{
     ...
     */
    public LineGenerator_orig( Rectangle2D rect, float gridUnit, float lpu )
    {
    ...
    {
        LineGenerator_orig       lineGen = new LineGenerator_orig( rect, 1, 1, -1 );
