...
/**
 * Application that builds on {@linkplain FormatterDemo1}.
 * In addition to validating input data,
 * it formats the text field's text using group separators
 * (e.g. "1,000,000" instead of "1000000").
 * It does this by adding a valueToString(Object) method
 * to the formatter ({@linkplain UnsignedIntFormatter}.
 * 
 * @author Jack Straub
 * 
 * @see FormatterDemo1
 ...
 */
public class JFormattedTextFieldDemo2
{
    /** Activity log. */
    ...
    */
    ...
    {
        SwingUtilities.invokeLater( () -> new JFormattedTextFieldDemo2() );
    }
     ...
     */
    public JFormattedTextFieldDemo2()
    {
        String      title       = "JFormattedTextField Demo 2";
