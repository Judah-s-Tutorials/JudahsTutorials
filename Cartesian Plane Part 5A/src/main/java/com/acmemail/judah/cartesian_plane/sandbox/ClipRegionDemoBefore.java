 ...
 * before applying a clip region.
 * 
 * @author Jack Straub
 *
 * @see ClipRegionDemoAfter
 */
@SuppressWarnings("serial")
public class ClipRegionDemoBefore extends JPanel
{
    ...
    {
        ClipRegionDemoBefore  canvas  = new ClipRegionDemoBefore();
