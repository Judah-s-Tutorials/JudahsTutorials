...
public class StreamTimer2
{
    ...
    private final long      numIterations   = 100;
    /** Number of test values per iteration. */
    private final long      numTestValues   = 10_000_000;
     ...
     */
    public String toReportString( StreamTimer2 other )
    {
        Stream<String>  labelStream = getLabels();
     ...
     *      in the given StreamTimer instance
     */
    private static Stream<String> getVals( StreamTimer2 timer )
    {
     ...
     * {@linkplain #toReportString(StreamTimer2)};
     * Each value 
     ...
     */
    private static Stream<String> getLabels()
    {
