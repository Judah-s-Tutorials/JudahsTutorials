 ...
 * @see #plot(Supplier)
 */
public class SimpleConsoleApp3_NoFiles
{
     ...
     */
    public SimpleConsoleApp3_NoFiles()
    {
        // not used
    }
    ...
    public static void main(String[] args)
    {
        ...
        )
        {
            ...
            while ( command != Command.EXIT )
            {
                switch ( command )
                {
                case YPLOT -> plot( () -> equation.yPlot() );
                case XYPLOT -> plot( () -> equation.xyPlot() );
                case RPLOT -> plot( () -> equation.rPlot() );
                case TPLOT -> plot( () -> equation.tPlot() );
                case SAVE, OPEN ->
